      ...
      <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-slate-400">
        ...
        <span className="flex items-center gap-1">
          <svg width="14" height="14" viewBox="0 0 24 24" aria-hidden="true">
            ...
            />
            <path fill="#FBBC05" d="M6.4 14a6 6 0 0 1 0-3.9V7.5H3A10 10 0 0 0 3 16.6L6.4 14Z" />
            <path
              fill="#EA4335"
              d="M12 6c1.5 0 2.8.5 3.8 1.5l2.9-2.8A9.7 9.7 0 0 0 3 7.5l3.4 2.6C7.2 7.8 9.4 6 12 6Z"
            />
          </svg>
          Google
        </span>
        ...
        <span className="flex items-center gap-1">
          <svg width="14" height="14" viewBox="0 0 24 24" aria-hidden="true">
            <path fill="#F48120" d="M16.9 17.5H5.2a3.2 3.2 0 0 1-.3-6.4 5.4 5.4 0 0 1 10.2-1.5 4 4 0 0 1 1.8 7.9Z" />
            <path
              fill="#FAAD3D"
              d="M18.8 12.4a3.7 3.7 0 0 0-1.2.2 4.7 4.7 0 0 0-8.8 1.7h10.8a1.6 1.6 0 0 1 0 3.2h-.8a2.6 2.6 0 0 0 0-5.1Z"
            />
          </svg>
          Cloudflare
        </span>
        <span className="flex items-center gap-1">
          <svg width="14" height="14" viewBox="0 0 24 24" aria-hidden="true">
            <path fill="#3ECF8E" d="M13.3 2.7 4.9 13.2h7.6l-1.8 8.1 8.4-10.5h-7.6l1.8-8.1Z" />
          </svg>
          Supabase
        </span>
      </div>
