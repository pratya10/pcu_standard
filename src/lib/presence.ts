...
// Listen-only variant for pages that watch a round (e.g. the live
// dashboard) without being an evaluator themselves — it must not track
// itself into the presence set, or the viewer would show up as if they
// were one of the people currently scoring.
export function subscribeToPresenceListenOnly(roundId: string, onSync: (online: PresenceInfo[]) => void) {
